...
exports.createAsset = asyncHandler(async (req, res) => {
    ...
    const asset = await assetService.createAsset(req.body, req.user, req.requestInfo);
...
exports.updateAsset = asyncHandler(async (req, res) => {
    ...
    const asset = await assetService.updateAsset(req.params.id, req.body, req.user, req.requestInfo);
...
exports.changeAssetStatus = asyncHandler(async (req, res) => { 
    ...
    const asset = await assetService.changeAssetStatus(req.params.id, req.user, req.requestInfo);
...
exports.deleteAsset = asyncHandler(async (req, res) => { 
    ...
    await assetService.deleteAsset(req.params.id, req.user, req.requestInfo);
...
exports.assignAsset = asyncHandler(async (req, res) => { 
    ...
    const asset = await assetService.assignAsset(req.params.id, req.body, req.user, req.requestInfo);
...
exports.returnAsset = asyncHandler(async (req, res) => { 
    ...
    const asset = await assetService.returnAsset(req.params.id, req.body, req.user, req.requestInfo);
